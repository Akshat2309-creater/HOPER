        ...
        <Dialog open={showContactDialog} onOpenChange={setShowContactDialog}>
          <DialogContent className="mx-4 w-[calc(100vw-2rem)] sm:w-auto sm:max-w-lg rounded-2xl p-6">
            ...
            <div className="flex flex-col gap-3 sm:gap-4 py-3 sm:py-4">
              ...
              <a
                href="https://www.google.com/maps/place/SHAHEED+SUKHDEV+COLLEGE+OF+BUSINESS+STUDIES/@28.7326341,77.1158925,17z/data=!3m1!4b1!4m6!3m5!1s0x390d013938e13ba5:0xbacd4c8f320fa4ff!8m2!3d28.7326294!4d77.1184674!16s%2Fg%2F11bc5_bj75?entry=ttu&g_ep=EgoyMDI1MTEwNC4xIKXMDSoASAFQAw%3D%3D"
                target="_blank"
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-xs sm:text-sm text-charcoal-gray break-words">Shaheed Sukhdev College of Business Studies, Delhi</p>
                </div>
              </a>
            </div>
          </DialogContent>
